...
public class WlRootFnImpl extends ASTWrapperPsiElement implements WlRootFn {

  public WlRootFnImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WlBlock getBlock() {
    return findNotNullChildByClass(WlBlock.class);
  }
