...
import com.qalens.corr.lang.core.jrn.psi.impl.*;
...
public interface JrnElementTypes {
  ...
  IElementType EXTRACTABLE_TEXT = new JrnElementType("EXTRACTABLE_TEXT");
  ...
  IElementType SEND_DATA_OVER_WEB_SOCKET_CLIENT_STEP = new JrnElementType("SEND_DATA_OVER_WEB_SOCKET_CLIENT_STEP");
  ...
  IElementType TRANSACTION_STEP = new JrnElementType("TRANSACTION_STEP");
  ...
  IElementType UNDEF_STEP = new JrnElementType("UNDEF_STEP");
  ...
  IElementType WEBSOCKET_CLIENT_CONNECT_STEP = new JrnElementType("WEBSOCKET_CLIENT_CONNECT_STEP");
  ...
  IElementType BINARY = new JrnTokenType("binary");
  ...
  IElementType CHUNKED = new JrnTokenType("chunked");
  IElementType CLIENT = new JrnTokenType("client");
  IElementType COLON = new JrnTokenType(":");
  IElementType COMMA = new JrnTokenType(",");
  IElementType CONCAT = new JrnTokenType("concat");
  IElementType CONNECT = new JrnTokenType("connect");
  ...
  IElementType ELSE = new JrnTokenType("else");
  ...
  IElementType LISTENER = new JrnTokenType("listener");
  ...
  IElementType MEASURE = new JrnTokenType("measure");
  ...
  IElementType NAMED = new JrnTokenType("named");
  IElementType NOW = new JrnTokenType("now");
  ...
  IElementType PUSH = new JrnTokenType("push");
  ...
  IElementType READWAV = new JrnTokenType("read_wav");
  ...
  IElementType SEND = new JrnTokenType("send");
  IElementType SERVER = new JrnTokenType("server");
  ...
  IElementType SYNC = new JrnTokenType("sync");
  ...
  IElementType UNDEF = new JrnTokenType("undef");
  ...
  IElementType WEBSOCKET = new JrnTokenType("websocket");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ARGED_FOR) {
        ...
        return new JrnBinaryOperatorImpl(node);
      }
      ...
      else if (type == EXTRACTABLE_TEXT) {
        return new JrnExtractableTextImpl(node);
      }
      ...
      else if (type == MULTI_VARIABLE_TEXT) {
        return new JrnMultiVariableTextImpl(node);
      }
      else if (type == NON_OPERATOR_EXPRESSION) {
        return new JrnNonOperatorExpressionImpl(node);
      }
      ...
      else if (type == SEND_DATA_OVER_WEB_SOCKET_CLIENT_STEP) {
        return new JrnSendDataOverWebSocketClientStepImpl(node);
      }
      ...
      else if (type == TRANSACTION_STEP) {
        return new JrnTransactionStepImpl(node);
      }
      else if (type == TYPE) {
      ...
      else if (type == UNDEF_STEP) {
        return new JrnUndefStepImpl(node);
      }
      ...
      else if (type == WEBSOCKET_CLIENT_CONNECT_STEP) {
        return new JrnWebsocketClientConnectStepImpl(node);
      }
