...
public class WlExecutorLineImpl extends ASTWrapperPsiElement implements WlExecutorLine {

  public WlExecutorLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WlVisitor visitor) {
    visitor.visitExecutorLine(this);
  }
