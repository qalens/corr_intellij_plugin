...
public class JrnTextTemplateImpl extends ASTWrapperPsiElement implements JrnTextTemplate {

  public JrnTextTemplateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitTextTemplate(this);
  }
