...
public class JrnTforValueScriptletImpl extends ASTWrapperPsiElement implements JrnTforValueScriptlet {

  public JrnTforValueScriptletImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitTforValueScriptlet(this);
  }
