...
public class JrnEScripletImpl extends ASTWrapperPsiElement implements JrnEScriplet {

  public JrnEScripletImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitEScriplet(this);
  }
