...
public class JrnForBlockImpl extends ASTWrapperPsiElement implements JrnForBlock {

  public JrnForBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JrnTforLoop getTforLoop() {
    return findNotNullChildByClass(JrnTforLoop.class);
  }
