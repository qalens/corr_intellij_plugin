...
public class JrnBracketedExpressionImpl extends ASTWrapperPsiElement implements JrnBracketedExpression {

  public JrnBracketedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
