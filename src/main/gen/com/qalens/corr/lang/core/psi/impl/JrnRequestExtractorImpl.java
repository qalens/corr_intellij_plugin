...
public class JrnRequestExtractorImpl extends ASTWrapperPsiElement implements JrnRequestExtractor {

  public JrnRequestExtractorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitRequestExtractor(this);
  }
