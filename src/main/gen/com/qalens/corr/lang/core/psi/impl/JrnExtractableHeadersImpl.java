...
public class JrnExtractableHeadersImpl extends ASTWrapperPsiElement implements JrnExtractableHeaders {

  public JrnExtractableHeadersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitExtractableHeaders(this);
  }
