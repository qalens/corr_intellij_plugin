...
public class JrnHeaderPairImpl extends ASTWrapperPsiElement implements JrnHeaderPair {

  public JrnHeaderPairImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitHeaderPair(this);
  }
