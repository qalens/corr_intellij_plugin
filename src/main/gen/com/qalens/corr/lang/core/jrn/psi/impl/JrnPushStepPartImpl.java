...
public class JrnPushStepPartImpl extends ASTWrapperPsiElement implements JrnPushStepPart {

  public JrnPushStepPartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JrnVisitor visitor) {
    visitor.visitPushStepPart(this);
  }
