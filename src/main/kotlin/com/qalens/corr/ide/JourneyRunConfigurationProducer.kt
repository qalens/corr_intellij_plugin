...
import com.qalens.corr.lang.core.psi.impl.JrnJourneyNameImpl
...
//        val module: Module = GaugeUtil.moduleForPsiElement(context.psiLocation) ?: return false
        ...
        try {
//            val name = context.psiLocation!!.containingFile.virtualFile.name
//            val scenarioIdentifier: Int = getScenarioIdentifier(context, context.psiLocation!!.containingFile)
//            if (scenarioIdentifier == NO_SCENARIOS || scenarioIdentifier == NON_SCENARIO_CONTEXT) {
//                return false
//            } else {
//                val scenarioName: String = getScenarioName(context)
